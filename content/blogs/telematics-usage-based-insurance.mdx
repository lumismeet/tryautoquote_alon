...
There are two common ways your driving gets measured, and it helps to know which one you're signing up for.
...
Whichever method is used, the categories being scored are fairly consistent: hard braking, rapid acceleration, sharp cornering, total miles driven, the time of day you're on the road, and increasingly, distracted-driving signals from your phone.
