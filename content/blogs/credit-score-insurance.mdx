...
Checking a quote does not lower your actual credit score. Insurers pull this data through a [soft inquiry](https://consumer.ftc.gov/articles/credit-scores), the same category of check that doesn't move your score the way a new credit card application would.

## Why Do Insurers Use Credit At All?

The justification is a statistical one. Large-scale research, including [a study the Federal Trade Commission conducted specifically on this question](https://www.ftc.gov/reports/credit-based-insurance-scores-impacts-consumers-automobile-insurance-report-congress-federal-trade), has found a real, measurable correlation between lower credit-based scores and both a higher likelihood of filing a claim and higher average claim costs when a claim occurs.
...
### How often should I check my credit before shopping for insurance?
...
### Is a credit-based insurance score the same at every insurer?
...
- [Federal Trade Commission, "Credit-Based Insurance Scores: Impacts on Consumers of Automobile Insurance" (Report to Congress)](https://www.ftc.gov/reports/credit-based-insurance-scores-impacts-consumers-automobile-insurance-report-congress-federal-trade)
- [Federal Trade Commission, "Credit Scores" (Consumer Advice)](https://consumer.ftc.gov/articles/credit-scores)