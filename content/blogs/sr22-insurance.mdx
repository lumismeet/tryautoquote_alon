...
An SR-22 is not a type of insurance. It's a certificate, sometimes called a certificate of financial responsibility, that your insurance company files directly with your state's Department of Motor Vehicles. It confirms that your liability coverage meets the state's minimum requirements, and it stays in place for a set period, during which your insurer is required to notify the state immediately if your coverage lapses or gets cancelled.
